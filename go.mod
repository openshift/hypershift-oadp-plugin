...
require (
	...
	github.com/openshift/cluster-api-provider-agent/api v0.0.0-20241216144637-44cd17b33d1f
	github.com/openshift/hypershift/api v0.0.0-20241220061156-5f05b35ce7e4
	github.com/openshift/oadp-operator v1.1.3
